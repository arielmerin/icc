...
public class Lista<T> implements Iterable<T> {
    ...
    */
    ...
    public Lista<T> mergeSort(Comparator<T> comparador) {
        ...
        return mezcla(izq.mergeSort(comparador), der.mergeSort(comparador), 
                                    comparador);
    }

    /**
     * Mezcla las dos listas que recibe como parámetro de tal forma que los 
     * elementos de ambas quedan ordenados en una sola lista.
     * @param izq los elementos de la lista que se encuentran a la izquierda
     * después de partir la lista aproximadamente a la mitad.
     * @param der los elementos de la lista que se encuentran a la derecha 
     * después de partir la lista aproximadamente a la mitad.
     * @param comparador el comparador que la lista usará para hacer el
     * ordenamiento.
     * @return la lista ordenada que obtenemos como resultado de mezclar las 
     * dos listas que recibimos como parámetro.
     */
    private Lista <T> mezcla(Lista<T> izq, Lista<T> der, 
                             Comparator<T> comparador) {
        Lista<T> lista = new Lista<T>();
        Lista<T>.Nodo n = izq.cabeza;
        Lista<T>.Nodo m = der.cabeza;
        
        while(n != null && m != null){
            if(comparador.compare(n.elemento, m.elemento) < 0) {
     ...
     * @param lista la lista en la que vamos a buscar el elemento.
     * @param elemento el elemento a buscar.
     * @param comparador el comparador con el que la lista está ordenada.
