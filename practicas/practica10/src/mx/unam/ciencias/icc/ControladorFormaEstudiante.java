...
public class ControladorFormaEstudiante extends ControladorForma {
    ...
    @FXML private void initialize() {
        ...
        entradaNombre.textProperty().addListener((o, v, n) -> verificaEstudiante());
        entradaCuenta.textProperty().addListener((o, v, n) -> verificaEstudiante());
        entradaPromedio.textProperty().addListener((o, v, n) -> verificaEstudiante());
        entradaEdad.textProperty().addListener((o, v, n) -> verificaEstudiante());
    }
    ...
    public void setEstudiante(Estudiante estudiante) {
        ...
        entradaCuenta.setText(String.format("%09d", estudiante.getCuenta()));
        entradaPromedio.setText(String.format("%2.2f", estudiante.getPromedio()));
    ...
    private boolean verificaCuenta(String c) {
        ...
        if (cuenta < 1000000 || cuenta > 99999999)
            return false;
        return true;
    }
