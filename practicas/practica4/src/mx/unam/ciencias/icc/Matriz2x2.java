...
public class Matriz2x2 {
    ...
    /**
     * Constructor único. Dado que no proveemos <em>setters</em>, nuestras matrices
     * de 2×2 son <em>inmutables</em>; no podemos cambiar sus valores.
     * 
     ...
     */
    public Matriz2x2(final double a, final double b, final double c, final double d) {
        this.a = a;
        this.b = b;
        this.c = c;
        this.d = d;
     ...
     */
    public Matriz2x2 suma(final Matriz2x2 m) {
        return new Matriz2x2(a + m.a, b + m.b, c + m.c, d + m.d);
    }

    /**
     * Multiplica la matriz de 2×2 con la matriz de 2×2 que recibe como parámetro.
     * 
     * @param m La matriz de 2×2 con la que hay que multiplicar.
     * @return La multiplicación con la matriz de 2×2 <tt>m</tt>.
     */
    public Matriz2x2 multiplica(final Matriz2x2 m) {
     ...
     */
    public Matriz2x2 multiplica(final double x) {
     ...
     * identidad.
     * 
     * @return La inversa de la matriz de 2×2, o <tt>null</tt> si la matriz no es
     *         invertible.
     */
    public Matriz2x2 inversa() {
        if (determinante() == 0)
            return null;
        return new Matriz2x2(d / determinante(), (-b) / determinante(), (-c) / determinante(), a / determinante());
    }
     ...
     */
    public Matriz2x2 potencia(final int n) {
        final Matriz2x2 matriz = new Matriz2x2(a, b, c, d);
        if (n < 2)
            return matriz;
        else
    ...
    /**
     * Regresa una representación en cadena de la matriz de 2×2. La representación
     * es de la forma:
     * 
     * <pre>
     ⎛ a  b ⎞
    ...
    public String toString() {
        ...
        final int n = Math.max(Math.max(sa.length(), sb.length()), Math.max(sc.length(), sd.length()));
